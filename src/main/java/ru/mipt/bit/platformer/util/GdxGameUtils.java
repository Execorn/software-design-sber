...
public final class GdxGameUtils {
  ...
  public static MapRenderer createSingleLayerMapRenderer(TiledMap tiledMap,
                                                         Batch batch) {
  ...
  public static <L extends MapLayer> L getSingleLayer(Map map) {
    ...
    case 1:
      @SuppressWarnings("unchecked") L layer = (L)layers.iterator().next();
      return layer;
    default:
  ...
  moveRectangleAtTileCenter(TiledMapTileLayer tileLayer, Rectangle rectangle,
  ...
  public static void drawTextureRegionUnscaled(Batch batch,
    ...
    batch.draw(region, rectangle.x, rectangle.y, regionOriginX, regionOriginY,
  ...
  public static float continueProgress(float previousProgress, float deltaTime,
                                       float speed) {
    return clamp(previousProgress + deltaTime / speed, 0f, 1f);
  }

  private static Vector2 calculateTileCenter(TiledMapTileLayer tileLayer,
                                             GridPoint2 tileCoordinates) {
